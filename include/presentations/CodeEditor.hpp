...
class CodeEditor final : public QWidget {
  ...
  private:
    ...
    bool keyEventNormalMode(QKeyEvent* event);
    bool keyEventVisualMode(QKeyEvent* event);
    bool keyEventInsertMode(QKeyEvent* event);

    Mode m_mode{Mode::Normal};
    int m_slideNumber{};

    VimPlainTextEdit* m_editor{};
